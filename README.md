...
- Messaging
    - INTERN
        ...
        - [Какие есть политики очистки в Kafka](Messaging/INTERN/Политики%20очистки%20Kafka.md)
    - JUNIOR
        - [Гарантии доставки Kafka, как это настраивается](Messaging/JUNIOR/Гарантии%20доставки%20Kafka.md)